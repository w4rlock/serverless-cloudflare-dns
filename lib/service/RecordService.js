...
class RecordService {
  ...
  async getDnsRecords(zoneId, query = {}) {
    ...
    try {
      const records = await this.CloudFlare.dnsRecords.browse(zoneId, q);
  ...
  create(zoneId, r = {}) {
    ...
    return this.CloudFlare.dnsRecords.add(zoneId, record);
  }
  ...
  update(zoneId, oldRecordId, record) {
    ...
    return this.CloudFlare.dnsRecords.edit(zoneId, oldRecordId, r);
  }
}
